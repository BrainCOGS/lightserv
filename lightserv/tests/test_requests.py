...
def test_mouse_request(test_client,test_login_nonadmin,
	...
	response = test_client.post(
		url_for('requests.new_request'),data={
			...
			'imaging_samples-0-image_resolution_forms-2-notes_for_imager':'image horizontally please!',
			...
			'imaging_samples-0-image_resolution_forms-3-notes_for_imager':'image horizontally please!',
			...
			'imaging_samples-0-image_resolution_forms-4-notes_for_imager':'image horizontally please!',
