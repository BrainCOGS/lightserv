...
class ExpTable_nolink(Table):
    border = True
    username = Col('username')
    experiment = Col('experiment')
    species = Col('species')
    clearing_protocol = Col('clearing_protocol')
    fluorophores = Col('fluorophores')
    primary_antibody = Col('primary_antibody')
    secondary_antibody = Col('secondary_antibody')
    image_resolution = Col('image_resolution')
