...
class iDiscoPlusImmunoForm(FlaskForm):
	...
	perfusion_date = OptionalDateField('Day 1: Perfusion')
	...
	time_dehydr_ch3oh_40percent_wash1 = OptionalDateTimeLocalField('40% CH3OH R@RTx1hr')
	time_dehydr_ch3oh_40percent_wash1_submit = SubmitField('Update')
	dehydr_ch3oh_40percent_wash1_notes = TextAreaField('Notes',validators=[Length(max=250)])
	dehydr_ch3oh_40percent_wash1_notes_submit = SubmitField('Update Notes')
	time_dehydr_ch3oh_60percent_wash1 = OptionalDateTimeLocalField('60% CH3OH R@RTx1hr')
	time_dehydr_ch3oh_60percent_wash1_submit = SubmitField('Update')
	dehydr_ch3oh_60percent_wash1_notes = TextAreaField('Notes',validators=[Length(max=250)])
	dehydr_ch3oh_60percent_wash1_notes_submit = SubmitField('Update Notes')
	time_dehydr_ch3oh_80percent_wash1 = OptionalDateTimeLocalField('80% CH3OH R@RTx1hr')
	time_dehydr_ch3oh_80percent_wash1_submit = SubmitField('Update')
	dehydr_ch3oh_80percent_wash1_notes = TextAreaField('Notes',validators=[Length(max=250)])
	dehydr_ch3oh_80percent_wash1_notes_submit = SubmitField('Update Notes')

	time_dehydr_ch3oh_100percent_wash1 = OptionalDateTimeLocalField('100% CH3OH R@RTx1hr (first hour)')
	time_dehydr_ch3oh_100percent_wash1_submit = SubmitField('Update')
	dehydr_ch3oh_100percent_wash1_notes = TextAreaField('Notes',validators=[Length(max=250)])
	dehydr_ch3oh_100percent_wash1_notes_submit = SubmitField('Update Notes')

	time_dehydr_ch3oh_100percent_wash2 = OptionalDateTimeLocalField('100% CH3OH R@RTx1hr (second hour)')
	time_dehydr_ch3oh_100percent_wash2_submit = SubmitField('Update')
	dehydr_ch3oh_100percent_wash2_notes = TextAreaField('Notes',validators=[Length(max=250)])
	dehydr_ch3oh_100percent_wash2_notes_submit = SubmitField('Update Notes')

	time_dehydr_h202_wash1 = OptionalDateTimeLocalField('5% H2O2(30%) in CH3OH(100%) O/N R@RT (1 part H2O2:5 parts methanol)')
	time_dehydr_h202_wash1_submit = SubmitField('Update')
	dehydr_h202_wash1_notes = TextAreaField('Notes',validators=[Length(max=250)])
	...
	time_rehydr_ch3oh_80percent_wash1 = OptionalDateTimeLocalField('80% CH3OH R@RTx1hr')
	time_rehydr_ch3oh_80percent_wash1_submit = SubmitField('Update')
	rehydr_ch3oh_80percent_wash1_notes = TextAreaField('Notes',validators=[Length(max=250)])
	rehydr_ch3oh_80percent_wash1_notes_submit = SubmitField('Update Notes')
	time_rehydr_ch3oh_60percent_wash1 = OptionalDateTimeLocalField('60% CH3OH R@RTx1hr')
	time_rehydr_ch3oh_60percent_wash1_submit = SubmitField('Update')
	rehydr_ch3oh_60percent_wash1_notes = TextAreaField('Notes',validators=[Length(max=250)])
	rehydr_ch3oh_60percent_wash1_notes_submit = SubmitField('Update Notes')
	time_rehydr_ch3oh_40percent_wash1 = OptionalDateTimeLocalField('40% CH3OH R@RTx1hr')
	time_rehydr_ch3oh_40percent_wash1_submit = SubmitField('Update')
	rehydr_ch3oh_40percent_wash1_notes = TextAreaField('Notes',validators=[Length(max=250)])
	rehydr_ch3oh_40percent_wash1_notes_submit = SubmitField('Update Notes')
	time_rehydr_ch3oh_20percent_wash1 = OptionalDateTimeLocalField('20% CH3OH R@RTx1hr')
	time_rehydr_ch3oh_20percent_wash1_submit = SubmitField('Update')
	rehydr_ch3oh_20percent_wash1_notes = TextAreaField('Notes',validators=[Length(max=250)])
	...
	time_clearing_ch3oh_40percent_wash1 = OptionalDateTimeLocalField('40% CH3OH R@RTx1hr')
	time_clearing_ch3oh_40percent_wash1_submit = SubmitField('Update')
	clearing_ch3oh_40percent_wash1_notes = TextAreaField('Notes',validators=[Length(max=250)])
	clearing_ch3oh_40percent_wash1_notes_submit = SubmitField('Update Notes')
	time_clearing_ch3oh_60percent_wash1 = OptionalDateTimeLocalField('60% CH3OH R@RTx1hr')
	time_clearing_ch3oh_60percent_wash1_submit = SubmitField('Update')
	clearing_ch3oh_60percent_wash1_notes = TextAreaField('Notes',validators=[Length(max=250)])
	clearing_ch3oh_60percent_wash1_notes_submit = SubmitField('Update Notes')
	time_clearing_ch3oh_80percent_wash1 = OptionalDateTimeLocalField('80% CH3OH R@RTx1hr')
	time_clearing_ch3oh_80percent_wash1_submit = SubmitField('Update')
	clearing_ch3oh_80percent_wash1_notes = TextAreaField('Notes',validators=[Length(max=250)])
	clearing_ch3oh_80percent_wash1_notes_submit = SubmitField('Update Notes')
	time_clearing_ch3oh_100percent_wash1 = OptionalDateTimeLocalField('100% CH3OH R@RTx1hr (hour 1)')
	time_clearing_ch3oh_100percent_wash1_submit = SubmitField('Update')
	clearing_ch3oh_100percent_wash1_notes = TextAreaField('Notes',validators=[Length(max=250)])
	clearing_ch3oh_100percent_wash1_notes_submit = SubmitField('Update Notes')
	time_clearing_ch3oh_100percent_wash2 = OptionalDateTimeLocalField('100% CH3OH R@RTx1hr (hour 2)')
	time_clearing_ch3oh_100percent_wash2_submit = SubmitField('Update')
	clearing_ch3oh_100percent_wash2_notes = TextAreaField('Notes',validators=[Length(max=250)])
	clearing_ch3oh_100percent_wash2_notes_submit = SubmitField('Update Notes')
	time_clearing_dcm_66percent_ch3oh_33percent = OptionalDateTimeLocalField('66% DCM / 33% CH3OH R@RTx3hrs')
	time_clearing_dcm_66percent_ch3oh_33percent_submit = SubmitField('Update')
	clearing_dcm_66percent_ch3oh_33percent_notes = TextAreaField('Notes',validators=[Length(max=250)])
...
class iDiscoAbbreviatedForm(FlaskForm):
	...
	dehydr_ch3oh_100percent_wash2_notes = TextAreaField('Notes:',validators=[Length(max=250)])
	dehydr_ch3oh_100percent_wash2_notes_submit = SubmitField('Update Notes')
	time_dehydr_dcm_66percent_ch3oh_33percent = OptionalDateTimeLocalField('66% DCM / 33% CH3OH R@RTx3hrs')
	time_dehydr_dcm_66percent_ch3oh_33percent_submit = SubmitField('Update')
	dehydr_dcm_66percent_ch3oh_33percent_notes = TextAreaField('Notes:',validators=[Length(max=250)])
...
class iDiscoAbbreviatedRatForm(FlaskForm):
	...
	dehydr_ch3oh_20percent_wash1_notes = TextAreaField('Notes:',validators=[Length(max=250)])
	dehydr_ch3oh_20percent_wash1_notes_submit = SubmitField('Update Notes')
	time_dehydr_ch3oh_40percent_wash1 = OptionalDateTimeLocalField('40% CH3OH R@RTX3hrs')
	time_dehydr_ch3oh_40percent_wash1_submit = SubmitField('Update')
	dehydr_ch3oh_40percent_wash1_notes = TextAreaField('Notes:',validators=[Length(max=250)])
	dehydr_ch3oh_40percent_wash1_notes_submit = SubmitField('Update Notes')
	time_dehydr_ch3oh_60percent_wash1 = OptionalDateTimeLocalField('60% CH3OH R@RTX3hrs')
	time_dehydr_ch3oh_60percent_wash1_submit = SubmitField('Update')
	dehydr_ch3oh_60percent_wash1_notes = TextAreaField('Notes:',validators=[Length(max=250)])
	dehydr_ch3oh_60percent_wash1_notes_submit = SubmitField('Update Notes')
	time_dehydr_ch3oh_80percent_wash1 = OptionalDateTimeLocalField('80% CH3OH R@RTX3hrs')
	time_dehydr_ch3oh_80percent_wash1_submit = SubmitField('Update')
	dehydr_ch3oh_80percent_wash1_notes = TextAreaField('Notes:',validators=[Length(max=250)])
	dehydr_ch3oh_80percent_wash1_notes_submit = SubmitField('Update Notes')
	time_dehydr_ch3oh_100percent_wash1 = OptionalDateTimeLocalField('100% CH3OH R@RTX3hrs')
	time_dehydr_ch3oh_100percent_wash1_submit = SubmitField('Update')
	dehydr_ch3oh_100percent_wash1_notes = TextAreaField('Notes:',validators=[Length(max=250)])
	dehydr_ch3oh_100percent_wash1_notes_submit = SubmitField('Update Notes')
	time_dehydr_ch3oh_100percent_wash2 = OptionalDateTimeLocalField('100% CH3OH R@RTX3hrs (or overnight)')
	time_dehydr_ch3oh_100percent_wash2_submit = SubmitField('Update')
	dehydr_ch3oh_100percent_wash2_notes = TextAreaField('Notes:',validators=[Length(max=250)])
	dehydr_ch3oh_100percent_wash2_notes_submit = SubmitField('Update Notes')
	time_dehydr_h202_wash1 = OptionalDateTimeLocalField('5% H202 / Methanol (1 part 30% H202: 5 parts 100% methanol) ')
	time_dehydr_h202_wash1_submit = SubmitField('Update')
	dehydr_h202_wash1_notes = TextAreaField('Notes:',validators=[Length(max=250)])
	dehydr_h202_wash1_notes_submit = SubmitField('Update Notes')
	time_dehydr_ch3oh_100percent_wash3 = OptionalDateTimeLocalField('100% CH3OH R@RTX2hrs')
	time_dehydr_ch3oh_100percent_wash3_submit = SubmitField('Update')
	dehydr_ch3oh_100percent_wash3_notes = TextAreaField('Notes:',validators=[Length(max=250)])
	dehydr_ch3oh_100percent_wash3_notes_submit = SubmitField('Update Notes')
	time_dehydr_ch3oh_100percent_wash4 = OptionalDateTimeLocalField('100% CH3OH R@RTX2hrs')
	time_dehydr_ch3oh_100percent_wash4_submit = SubmitField('Update')
	dehydr_ch3oh_100percent_wash4_notes = TextAreaField('Notes:',validators=[Length(max=250)])
	dehydr_ch3oh_100percent_wash4_notes_submit = SubmitField('Update Notes')
	time_dehydr_ch3oh_100percent_wash5 = OptionalDateTimeLocalField('100% CH3OH R@RTX2hrs (or overnight)')
	time_dehydr_ch3oh_100percent_wash5_submit = SubmitField('Update')
	dehydr_ch3oh_100percent_wash5_notes = TextAreaField('Notes:',validators=[Length(max=250)])
	dehydr_ch3oh_100percent_wash5_notes_submit = SubmitField('Update Notes')

	time_dehydr_dcm_66percent_ch3oh_33percent = OptionalDateTimeLocalField('66% DCM / 33% CH3OH R@RTx6hrs')
	time_dehydr_dcm_66percent_ch3oh_33percent_submit = SubmitField('Update')
	dehydr_dcm_66percent_ch3oh_33percent_notes = TextAreaField('Notes:',validators=[Length(max=250)])
	dehydr_dcm_66percent_ch3oh_33percent_notes_submit = SubmitField('Update Notes')
