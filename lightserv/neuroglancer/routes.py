...
@neuroglancer.route("/neuroglancer/sandbox",
    methods=['GET','POST'])
@logged_in
@log_http_requests
def sandbox():
    """ A route for generating a link to Neuroglancer to show Jess'
    201904_ymaze_cfos an21 brain as an example for people to play around with."""
    ...
    requests.post('http://viewer-launcher:5005/ng_sandbox_launcher',json=ng_dict)
    logger.debug("Made post request to viewer-launcher to launch ng sandbox viewer")
