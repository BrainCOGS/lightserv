...
if __name__ == "__main__":
    ...
    parser.add_argument("x_dim", help="Size of volume in x in pixels")
    parser.add_argument("y_dim", help="Size of volume in y in pixels")
    parser.add_argument("z_dim", help="Size of volume in z in pixels")
    ...
    # logging.debug(x_dim,y_dim,z_dim)
    # # vol = make_info_file(volume_size=(x_dim,y_dim,z_dim),layer_name='testlayer')
